...
let showName
  if(props.path.slice(1) === 'womencloth'){
    showName='Women cloth'
  }else if(props.path.slice(1) === 'mencloth'){
    showName='Men cloth'
  }else{
    showName= props.path.slice(1)
  }
  ...
  return (
    <div className={classes.cloth} >
      <div className={classes['cart-content']} >
        ...
        <Button className='general'><Link to={props.path} >Go to {showName}</Link></Button>
